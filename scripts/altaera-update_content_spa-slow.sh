echo "Actualizando los archivos shell de AltaeraAI ...
...
wget https://raw.githubusercontent.com/ThinkThroughLabs/AltaeraAI/main/scripts/altaera-updated_successfully_spa.sh -O 'altaera-updated_successfully.sh'
...
echo "Actualizando los archivos del núcleo de AltaeraAI ...
...
echo "Actualización del entorno AltaeraAI PRoot Distro (Artix Linux) ...";
