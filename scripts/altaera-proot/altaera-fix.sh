...
MENU="Would you like to fix with the pre-packaged KoboldCpp [Faster], or by building your own? [Slower]"

OPTIONS=(1 "Fix with pre-packaged KoboldCpp [Faster]"
         2 "Fix with building your own KoboldCpp [Slower]"
         3 "Fix with building your own KoboldCpp (No-Blas) [Slower]")
