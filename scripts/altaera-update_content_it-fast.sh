echo "Aggiornamento dei file della shell di AltaeraAI ...
...
echo "Aggiornamento dei file del core di AltaeraAI ...
...
echo "Aggiornamento dell'ambiente AltaeraAI PRoot Distro (Artix Linux) ...";
