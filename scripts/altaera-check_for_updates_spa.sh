...
dialog --title "Comprobación de actualizaciones" \
        --backtitle "AltaeraAI" \
        --yesno "¿Desea comprobar si hay actualizaciones?" 7 60

response=$?
case $response in

        0)      
        echo "Comprobación de la disponibilidad de actualizaciones ...";
