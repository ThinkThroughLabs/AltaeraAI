...
URL='https://huggingface.co/mlabonne/gemma-3-4b-it-abliterated-GGUF/resolve/main/gemma-3-4b-it-abliterated.q2_k.gguf'
OUTPUT='q2_k-gemma-3-4b-it-abliterated.gguf'
...
URL='https://huggingface.co/mlabonne/gemma-3-4b-it-abliterated-GGUF/resolve/main/gemma-3-4b-it-abliterated.q3_k_m.gguf'
OUTPUT='q3_k_m.gemma-3-4b-it-abliterated.gguf'
wget -q --show-progress "$URL" -O "$OUTPUT" &
WGET_PID=$!
...
OUTPUT='q4_k_m.gemma-3-4b-it-abliterated.gguf'
wget -q --show-progress "$URL" -O "$OUTPUT" &
WGET_PID=$!
...
URL='https://huggingface.co/mlabonne/gemma-3-4b-it-abliterated-GGUF/resolve/main/gemma-3-4b-it-abliterated.q5_k_m.gguf'
OUTPUT='q5_k_m.gemma-3-4b-it-abliterated.gguf'
wget -q --show-progress "$URL" -O "$OUTPUT" &
WGET_PID=$!
...
URL='https://huggingface.co/mlabonne/gemma-3-4b-it-abliterated-GGUF/resolve/main/gemma-3-4b-it-abliterated.q6_k.gguf'
OUTPUT='q6_k-gemma-3-4b-it-abliterated.gguf'
wget -q --show-progress "$URL" -O "$OUTPUT" &
WGET_PID=$!
...
URL='https://huggingface.co/mlabonne/gemma-3-4b-it-abliterated-GGUF/resolve/main/gemma-3-4b-it-abliterated.fp16.gguf'
OUTPUT='f16-gemma-3-4b-it-abliterated.gguf'
wget -q --show-progress "$URL" -O "$OUTPUT" &
WGET_PID=$!
