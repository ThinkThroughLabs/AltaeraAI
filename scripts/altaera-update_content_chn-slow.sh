...
wget https://raw.githubusercontent.com/ThinkThroughLabs/AltaeraAI/main/scripts/altaera-updated_successfully_chn.sh -O 'altaera-updated_successfully.sh'
...
wget https://raw.githubusercontent.com/ThinkThroughLabs/AltaeraAI/main/scripts/altaera-update-proot_chn.sh -O 'altaera-update-proot.sh'
