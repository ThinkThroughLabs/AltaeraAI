...
WIDTH=100
CHOICE_HEIGHT=24
BACKTITLE="AltaeraAI - Termux update"
TITLE="Choosing updating method"
MENU="Where was your Termux downloaded from? - Necessary for the update to work"
...
" | sed  -e :a -e "s/^.\{1,$(tput cols)\}$/ & /;ta" | tr -d '\n' | head -c $(tput cols);
          ...
          {
                  cd '/sdcard/Download'
                  wget https://github.com/ThinkThroughLabs/termux-releases/releases/download/0.118.1/com.termux_118.1.apk
                  chmod a+x 'com.termux_118.1.apk'
          } &> /dev/null 2>&1;
...
" | sed  -e :a -e "s/^.\{1,$(tput cols)\}$/ & /;ta" | tr -d '\n' | head -c $(tput cols);
          ...
          {
                  cd '/sdcard/Download'
                  wget https://f-droid.org/repo/com.termux_1000.apk -O 'com.termux_118.1.apk'
                  chmod a+x 'com.termux_118.1.apk'
          } &> /dev/null 2>&1;
