echo "Оновлення файлів оболонки AltaeraAI ...
...
wget https://raw.githubusercontent.com/ThinkThroughLabs/AltaeraAI/main/scripts/altaera-updated_successfully_ukr.sh -O 'altaera-updated_successfully.sh'
...
echo "Оновлення основних файлів AltaeraAI ...
...
echo "Оновлення середовища AltaeraAI PRoot Distro (Artix Linux) ...";
