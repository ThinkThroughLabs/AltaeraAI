clear
        ...
        echo "Checking for instabilities...";
         ...
         if [ $(bash 'AltaeraAI/altaera-functional_status.sh'
          ...
          --msgbox 'AltaeraAI is experiencing malfunctions at this very moment. If you have recently downloaded or updated it, chances are some things will be broken. Please, give us some time to carry out code repairs. Sorry for the inconvenience!' 20 40
