...
echo -n "Checking for instabilities [ ... ] " | pv -qL 200
...
echo -n "Automatically checking for updates [ ... ] " | pv -qL 200
...
echo -n "Running essential file integrity checks [ ... ] " | pv -qL 200
sleep .5
