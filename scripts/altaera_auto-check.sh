...
echo -n "Checking for instabilities [ ... ] " | pv -qL 100
...
echo -n "Automatically checking for updates [ ... ] " | pv -qL 100
...
echo -n "Running essential file integrity checks [ ... ] " | pv -qL 100
sleep .5
