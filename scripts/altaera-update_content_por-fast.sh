echo "Atualização dos ficheiros da shell AltaeraAI ...
...
rm -rf 'altaera-custom_ai_model.sh'
...
rm -rf 'altaera-custom_ai_model_url.sh'
...
rm -rf 'altaera-model-gemma-3-1b-it.sh'
wget https://raw.githubusercontent.com/ThinkThroughLabs/AltaeraAI/refs/heads/main/scripts/altaera-model-gemma-3-1b-it.sh
...
rm -rf 'altaera-model-gemma-2-2b-it-abliterated.sh'
wget https://raw.githubusercontent.com/ThinkThroughLabs/AltaeraAI/main/scripts/altaera-model-gemma-2-2b-it-abliterated.sh
chmod a+x 'altaera-model-gemma-2-2b-it-abliterated.sh'
...
wget https://raw.githubusercontent.com/ThinkThroughLabs/AltaeraAI/main/scripts/altaera-updated_successfully_por.sh -O 'altaera-updated_successfully.sh'
...
echo "Atualização dos ficheiros principais do AltaeraAI ...
...
rm -rf '/data/data/com.termux/files/usr/var/lib/proot-distro/installed-rootfs/altaera/root/kcpp-ae_v6.1.0.tar.gz'
...
echo "Atualização do ambiente da distro AltaeraAI PRoot (Artix Linux) ...";
